export function getCategoryStyles(category: number) {
	switch (category) {
		case 1:
			return {
				label: 'Major Hub',
				badgeClass: 'border-purple-400/50 bg-purple-400/20 text-purple-100',
				cardClass:
		...
		case 2:
			return {
				label: 'Important',
				badgeClass: 'border-cyan-400/50 bg-cyan-400/20 text-cyan-100',
				cardClass:
		...
		case 4:
			return {
				label: 'Medium',
				badgeClass: 'border-green-400/50 bg-green-400/20 text-green-100',
				cardClass:
		...
		default:
			return {
				label: 'Station',
				badgeClass: 'border-gray-400/50 bg-gray-400/20 text-gray-100',
				cardClass:
